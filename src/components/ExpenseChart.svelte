...
<div class="bg-white p-4 rounded-lg shadow-md flex flex-col h-full">
    ...
    <button class="mt-4 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-300 cursor-pointer" on:click={() => isHistoryModalOpen = true}>
